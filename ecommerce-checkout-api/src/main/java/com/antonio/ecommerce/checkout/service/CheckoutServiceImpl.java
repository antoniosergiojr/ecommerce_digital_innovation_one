package com.antonio.ecommerce.checkout.service;

import com.antonio.ecommerce.checkout.entity.CheckoutEntity;
import com.antonio.ecommerce.checkout.entity.CheckoutItemEntity;
import com.antonio.ecommerce.checkout.entity.ShippingEntity;
import com.antonio.ecommerce.checkout.event.CheckoutCreatedEvent;
import com.antonio.ecommerce.checkout.repository.CheckoutRepository;
import com.antonio.ecommerce.checkout.resource.checkout.CheckoutRequest;
import com.antonio.ecommerce.checkout.streaming.CheckoutCreatedSource;
import com.antonio.ecommerce.checkout.util.UUIDUtil;
...
@Service // criar uma instancia do servico e fazer a injecao de dependecia 
@RequiredArgsConstructor
@Slf4j
public class CheckoutServiceImpl implements CheckoutService {

    //@Autowired nao usar, o correto e usar anotacao na classe (RequiredArgsConstructor), pois facilita na implementacao dos testes
